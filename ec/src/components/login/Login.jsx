                ...
                <div className="place-content-center flex">
                    <div className="box-border mt-40 w-[45%] bg-gray-200 rounded-2xl shadow-2xl" data-aos="fade-left">
                        ...
                        <div className="ml-48 mt-3">
                            Username :
                            <input type="text" placeholder="Username" value={username} onChange={(e) => setUsername(e.target.value)} className="ml-3 mt-3 w-[40%] rounded-lg text-gray-700 text-center" />
                            <br />
                            Password :
                            <input type="password" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} className="ml-4 mt-7 w-[40%] rounded-lg text-gray-700 text-center" />
                            {error && <p className="text-red-500 mt-2">{error}</p>}
                        </div>
                        <div className="flex justify-end mr-16 mt-5">
                            <button onClick={handleLogin} className="bg-gray-300 hover:bg-gradient-to-r from-cyan-200 to-blue-200 w-20 h-14 rounded-2xl mb-2 hover:font-bold hover:font-mono">Login</button>
                        </div>
                    </div>
                </div>
            </div>
