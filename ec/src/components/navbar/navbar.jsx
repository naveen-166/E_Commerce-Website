        ...
        <div className='flex flex-row  bg-slate-100'>
            <div className=' bg-slate-100 flex flex-row w-[30%]'>
                <div className=' text-black h-[8vh]'>
                    <ul className='flex flex-row p-3 ' data-aos="fade-up">
                        <li className="text-center mx-2 p-1 pl-3 hover:text-lg hover:font-bold hover:duration-100"><button id='/' onClick={click}>Home</button></li>
                        <li className="text-center mx-2 p-1 pl-3 hover:text-lg hover:font-bold hover:duration-100"><button id='/men' onClick={click}>Men</button></li>
                        <li className="text-center mx-2 p-1 pl-3 hover:text-lg hover:font-bold hover:duration-100"><button id='/womens' onClick={click}>Women</button></li>
                        <li className="text-center mx-2 p-1 pl-3 hover:text-lg hover:font-bold hover:duration-100"><button id='/newarival' onClick={click}>New Arrivals</button></li>
                    </ul>
                </div>
            </div>
            ...
            <div className='flex justify-start m-2 justify-items-end ml-auto flex space-x-5 mr-10' data-aos="fade-up">
                ...
                <div className=' flex flex-row'>
                    <a href='/login'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-9 mt-1">
